...
const TaskItem = ({ task }) => {
    ...
    if (isEditing) {
        return (
            <div className={`task-item ${priorityStyles[task.priority].border} bg-gray-50`}>
                <TaskForm
                    task={task}
                ...
                <div className="flex items-start space-x-3 flex-1">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                            <span className={`priority-badge ${priorityStyles[task.priority].badge}`}>
                        ...
                        {(isExpanded && task.description) && (
                            <p className={`mt-3 text-gray-600 ${task.completed ? 'completed-task' : ''}`}>
                                {task.description}
                            </p>
                        )}
                    </div>
